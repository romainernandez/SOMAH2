...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //TODO: delete image default blank
    ...
    public void insertMockData(SQLiteDatabase db){
        ...
        String[] allLanguageName = {"German", "English", "French", "Norwegian Bokmål"};
    ...
    public List<Category> getAllTopics(int periodId){
        ...
        try {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    category.setId(cursor.getInt(cursor.getColumnIndex(TOPIC_ID)));
                    category.setName(cursor.getString(cursor.getColumnIndex(TOPIC_TR_NAME)));
                    Log.d("Romain", "getAllTopics: categoy= " + category.getName());
